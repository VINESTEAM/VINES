...
for k,v in pairs(Ids_Dev) do  
if Status or  msg.sender_user_id_ == v then  
Dev_VINES = true  
end  
end  
return Dev_VINES  
...
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id="..redis:get(bot_id..'zzzKz').."&user_id="..User);
...
if text == ("اضف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_VINESEnd(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text == ("حذف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_VINESEnd(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text and text:match("^اضف مطور ثانوي @(.*)$") and Dev_VINESEnd(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text and text:match("^حذف مطور ثانوي @(.*)$") and Dev_VINESEnd(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text and text:match("^اضف مطور ثانوي (%d+)$") and Dev_VINESEnd(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text and text:match("^حذف مطور ثانوي (%d+)$") and Dev_VINESEnd(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text and text:match("^اضف مطور @(.*)$") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text and text:match("^حذف مطور @(.*)$") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text and text:match("^اضف مطور (%d+)$") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
if text and text:match("^حذف مطور (%d+)$") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
File:write(Get_Json)
File:close()
sendDocument(Id_Dev, 0,'./lib/'..bot_id..'.json', '\n⌔︙تم جلب نسخه خاصه بالكروبات\n⌔︙يحتوي الملف على {'..#Groups..'} مجموعه')
...
if text == ("مسح قائمه العام") and Dev_VINES(msg) or text == ("مسح المحظورين عام") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
redis:del(bot_id.."Removal:User:Groups")
send(msg.chat_id_, msg.id_, "⌔︙تم مسح المحظورين عام من البوت")
elseif text == ("مسح الثانويين") and Dev_VINESEnd(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
redis:del(bot_id.."Dev2Bot")
elseif text == ("مسح المطورين") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
elseif text == ("قائمه العام") and Dev_VINES(msg) or text == ("المحظورين عام") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
send(msg.chat_id_, msg.id_, Gban)
elseif text == ("الثانويين") and Dev_VINESEnd(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
elseif text == ("المطورين") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text and text:match("^حظر عام @(.*)$") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
elseif text and text:match("^حظر عام (%d+)$") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
elseif text and text:match("^الغاء العام (%d+)$") and Dev_VINES(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙بليز اشترك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- '..redis:get(bot_id.."zzzKz"))   
return false
end
...
elseif text and text:match("^(وضع وقت التنظيف) (%d+)$") and BasicBuilder(msg) then
